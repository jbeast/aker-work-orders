...
RSpec.describe 'WorkOrderSplitter' do
  ...
  before :each do
    ...
    stub_request(:post, "http://external-server:3000/api/v1/sets/28d7c0e2-9935-41b1-a806-e9b22324d41f/relationships/materials")
      .with(
        body: "{\"data\":[{\"id\":\"01cb5442-f7f1-4247-813e-8e7693b0b17d\",\"type\":\"materials\"},{\"id\":\"030a06d1-0309-4fb0-8c7f-571d5c8dcebc\",\"type\":\"materials\"},{\"id\":\"056ee9c0-0a9d-4213-bb68-0aacbc53653b\",\"type\":\"materials\"},{\"id\":\"06816dc3-f68e-4491-9b24-36a00e79133e\",\"type\":\"materials\"},{\"id\":\"082828d2-9635-4b7d-ba4c-46bddcb6692c\",\"type\":\"materials\"}]}",
        headers: {
    ...
    stub_request(:post, "http://external-server:3000/api/v1/sets/28d7c0e2-9935-41b1-a806-e9b22324d42d/relationships/materials")
      .with(
        body: "{\"data\":[{\"id\":\"086a5a64-4444-4e59-a80f-e3f4c4d42ded\",\"type\":\"materials\"},{\"id\":\"0a11302b-2ad6-469a-82c0-78b9c085f9f0\",\"type\":\"materials\"},{\"id\":\"0da6e13f-688a-459c-bf40-a341788662b4\",\"type\":\"materials\"},{\"id\":\"1341c67e-a88e-4476-9b7b-d53b1e5fb0ec\",\"type\":\"materials\"},{\"id\":\"13449bb3-1a82-4ddc-9969-db6de5f20b9e\",\"type\":\"materials\"}]}",
        headers: {
          'Accept'=>'application/vnd.api+json',
          'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
          'Content-Type'=>'application/vnd.api+json',
    ...
    stub_request(:patch, "http://external-server:3000/api/v1/sets/28d7c0e2-9935-41b1-a806-e9b22324d41f")
      .with(
        body: "{\"data\":{\"id\":\"28d7c0e2-9935-41b1-a806-e9b22324d41f\",\"type\":\"sets\",\"attributes\":{\"owner_id\":\"owner@sanger.ac.uk\",\"locked\":true}}}",
        headers: {
          'Accept'=>'application/vnd.api+json',
          'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
          'Content-Type'=>'application/vnd.api+json',
    ...
    stub_request(:patch, "http://external-server:3000/api/v1/sets/28d7c0e2-9935-41b1-a806-e9b22324d42d")
      .with(
        body: "{\"data\":{\"id\":\"28d7c0e2-9935-41b1-a806-e9b22324d42d\",\"type\":\"sets\",\"attributes\":{\"owner_id\":\"owner@sanger.ac.uk\",\"locked\":true}}}",
        headers: {
          'Accept'=>'application/vnd.api+json',
          'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
          'Content-Type'=>'application/vnd.api+json',
    ...
    @splitter = WorkOrderSplitter::Splitter.new(work_order: work_order)
